...
1. ❗️ Closed issue [#4](https://github.com/pytest-dev/pytest-env/issues/4) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
2. 🗣 Commented on [#4](https://github.com/pytest-dev/pytest-env/issues/4) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
3. 🎉 Merged PR [#9](https://github.com/pytest-dev/pytest-env/pull/9) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
4. 🗣 Commented on [#9](https://github.com/pytest-dev/pytest-env/issues/9) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
5. 🗣 Commented on [#9](https://github.com/pytest-dev/pytest-env/issues/9) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
