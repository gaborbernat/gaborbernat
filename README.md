...
1. 🎉 Merged PR [#23](https://github.com/pytest-dev/pytest-print/pull/23) in [pytest-dev/pytest-print](https://github.com/pytest-dev/pytest-print)
2. ❗️ Closed issue [#2037](https://github.com/tox-dev/tox/issues/2037) in [tox-dev/tox](https://github.com/tox-dev/tox)
3. 🎉 Merged PR [#2150](https://github.com/tox-dev/tox/pull/2150) in [tox-dev/tox](https://github.com/tox-dev/tox)
4. 🗣 Commented on [#1975](https://github.com/tox-dev/tox/issues/1975) in [tox-dev/tox](https://github.com/tox-dev/tox)
5. 🎉 Merged PR [#21](https://github.com/gaborbernat/sphinx-argparse-cli/pull/21) in [gaborbernat/sphinx-argparse-cli](https://github.com/gaborbernat/sphinx-argparse-cli)
