...
1. 🎉 Merged PR [#128](https://github.com/tox-dev/tox-ansible/pull/128) in [tox-dev/tox-ansible](https://github.com/tox-dev/tox-ansible)
2. 🎉 Merged PR [#42](https://github.com/tox-dev/sphinx-argparse-cli/pull/42) in [tox-dev/sphinx-argparse-cli](https://github.com/tox-dev/sphinx-argparse-cli)
3. 🎉 Merged PR [#44](https://github.com/tox-dev/tox-bindep/pull/44) in [tox-dev/tox-bindep](https://github.com/tox-dev/tox-bindep)
4. 🎉 Merged PR [#34](https://github.com/tox-dev/tox-via-docker/pull/34) in [tox-dev/tox-via-docker](https://github.com/tox-dev/tox-via-docker)
5. 🎉 Merged PR [#21](https://github.com/tox-dev/pyproject-fmt/pull/21) in [tox-dev/pyproject-fmt](https://github.com/tox-dev/pyproject-fmt)
