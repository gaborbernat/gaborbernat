...
1. 🎉 Merged PR [#2399](https://github.com/tox-dev/tox/pull/2399) in [tox-dev/tox](https://github.com/tox-dev/tox)
2. 🎉 Merged PR [#128](https://github.com/tox-dev/tox-ansible/pull/128) in [tox-dev/tox-ansible](https://github.com/tox-dev/tox-ansible)
3. 🎉 Merged PR [#42](https://github.com/tox-dev/sphinx-argparse-cli/pull/42) in [tox-dev/sphinx-argparse-cli](https://github.com/tox-dev/sphinx-argparse-cli)
4. 🎉 Merged PR [#44](https://github.com/tox-dev/tox-bindep/pull/44) in [tox-dev/tox-bindep](https://github.com/tox-dev/tox-bindep)
5. 🎉 Merged PR [#34](https://github.com/tox-dev/tox-via-docker/pull/34) in [tox-dev/tox-via-docker](https://github.com/tox-dev/tox-via-docker)
