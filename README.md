...
1. 🎉 Merged PR [#1973](https://github.com/tox-dev/tox/pull/1973) in [tox-dev/tox](https://github.com/tox-dev/tox)
2. ❗️ Opened issue [#94](https://github.com/m-burst/flake8-pytest-style/issues/94) in [m-burst/flake8-pytest-style](https://github.com/m-burst/flake8-pytest-style)
3. 🗣 Commented on [#1970](https://github.com/tox-dev/tox/issues/1970) in [tox-dev/tox](https://github.com/tox-dev/tox)
4. 🎉 Merged PR [#1971](https://github.com/tox-dev/tox/pull/1971) in [tox-dev/tox](https://github.com/tox-dev/tox)
