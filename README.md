...
1. ❗️ Opened issue [#11105](https://github.com/python/mypy/issues/11105) in [python/mypy](https://github.com/python/mypy)
2. 🎉 Merged PR [#26](https://github.com/pytest-dev/pytest-print/pull/26) in [pytest-dev/pytest-print](https://github.com/pytest-dev/pytest-print)
3. ❗️ Closed issue [#2167](https://github.com/tox-dev/tox/issues/2167) in [tox-dev/tox](https://github.com/tox-dev/tox)
4. 🎉 Merged PR [#2207](https://github.com/tox-dev/tox/pull/2207) in [tox-dev/tox](https://github.com/tox-dev/tox)
5. 🎉 Merged PR [#23](https://github.com/gaborbernat/sphinx-argparse-cli/pull/23) in [gaborbernat/sphinx-argparse-cli](https://github.com/gaborbernat/sphinx-argparse-cli)
