...
1. 🎉 Merged PR [#3215](https://github.com/tox-dev/tox/pull/3215) in [tox-dev/tox](https://github.com/tox-dev/tox)
2. 🎉 Merged PR [#264](https://github.com/platformdirs/platformdirs/pull/264) in [platformdirs/platformdirs](https://github.com/platformdirs/platformdirs)
3. 🎉 Merged PR [#96](https://github.com/pytest-dev/pytest-print/pull/96) in [pytest-dev/pytest-print](https://github.com/pytest-dev/pytest-print)
4. 🎉 Merged PR [#72](https://github.com/pytest-dev/pytest-env/pull/72) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
5. 🎉 Merged PR [#7](https://github.com/tox-dev/py-discovery/pull/7) in [tox-dev/py-discovery](https://github.com/tox-dev/py-discovery)
