...
1. 🚀 Published release [4.0.2](https://github.com/tox-dev/pre-commit-uv/releases/tag/4.0.2) in [tox-dev/pre-commit-uv](https://github.com/tox-dev/pre-commit-uv)
2. 🔒 Closed issue [#3](https://github.com/tox-dev/pre-commit-uv/issues/3) in [tox-dev/pre-commit-uv](https://github.com/tox-dev/pre-commit-uv)
3. 🗣 Commented on [#3](https://github.com/tox-dev/pre-commit-uv/issues/3#issuecomment-2274400988) in [tox-dev/pre-commit-uv](https://github.com/tox-dev/pre-commit-uv)
4. 🗣 Commented on [#3](https://github.com/tox-dev/pre-commit-uv/issues/3#issuecomment-2274369626) in [tox-dev/pre-commit-uv](https://github.com/tox-dev/pre-commit-uv)
5. 🚀 Published release [4.0.1](https://github.com/tox-dev/pre-commit-uv/releases/tag/4.0.1) in [tox-dev/pre-commit-uv](https://github.com/tox-dev/pre-commit-uv)
