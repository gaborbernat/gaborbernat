...
3. 🎉 Merged PR [#6](https://github.com/pytest-dev/pytest-env/pull/6) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
4. 💪 Opened PR [#6](https://github.com/pytest-dev/pytest-env/pull/6) in [pytest-dev/pytest-env](https://github.com/pytest-dev/pytest-env)
5. 🎉 Merged PR [#57](https://github.com/tox-dev/tox-extra/pull/57) in [tox-dev/tox-extra](https://github.com/tox-dev/tox-extra)
