...
2. 🎉 Merged PR [#2178](https://github.com/tox-dev/tox/pull/2178) in [tox-dev/tox](https://github.com/tox-dev/tox)
3. 🎉 Merged PR [#21](https://github.com/tox-dev/tox-extra/pull/21) in [tox-dev/tox-extra](https://github.com/tox-dev/tox-extra)
4. 🎉 Merged PR [#19](https://github.com/tox-dev/tox-via-docker/pull/19) in [tox-dev/tox-via-docker](https://github.com/tox-dev/tox-via-docker)
5. 🎉 Merged PR [#21](https://github.com/tox-dev/cookiecutter-tox-plugin/pull/21) in [tox-dev/cookiecutter-tox-plugin](https://github.com/tox-dev/cookiecutter-tox-plugin)
