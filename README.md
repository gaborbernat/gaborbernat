...
1. 🎉 Merged PR [#150](https://github.com/tox-dev/tox-conda/pull/150) in [tox-dev/tox-conda](https://github.com/tox-dev/tox-conda)
2. ❌ Closed PR [#2556](https://github.com/tox-dev/tox/pull/2556) in [tox-dev/tox](https://github.com/tox-dev/tox)
3. 🎉 Merged PR [#45](https://github.com/tox-dev/tox-via-docker/pull/45) in [tox-dev/tox-via-docker](https://github.com/tox-dev/tox-via-docker)
4. ❌ Closed PR [#112](https://github.com/tox-dev/tox-ini-fmt/pull/112) in [tox-dev/tox-ini-fmt](https://github.com/tox-dev/tox-ini-fmt)
5. 🎉 Merged PR [#148](https://github.com/tox-dev/tox-docker/pull/148) in [tox-dev/tox-docker](https://github.com/tox-dev/tox-docker)
